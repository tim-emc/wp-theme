 ...
 */
function wp_theme_customize( $wp_customize ) {
	/**
	 * Initialize sections
	 */
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			'header_logo',
			array(
				'label'       => __( 'Upload Header Logo', 'wp-theme' ),
				'description' => __( 'Height: &gt;80px', 'wp-theme' ),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'label'    => __( 'Navbar Scheme', 'wp-theme' ),
			'section'  => 'theme_header_section',
			'choices'  => array(
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'label'    => __( 'Navbar', 'wp-theme' ),
			'section'  => 'theme_header_section',
			'choices'  => array(
				'static'       => __( 'Static', 'wp-theme' ),
				'fixed_top'    => __( 'Fixed to top', 'wp-theme' ),
				'fixed_bottom' => __( 'Fixed to bottom', 'wp-theme' ),
			),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'checkbox',
			'label'    => __( 'Show Searchfield?', 'wp-theme' ),
			'section'  => 'theme_header_section',
...
add_action( 'customize_register', 'wp_theme_customize' );
